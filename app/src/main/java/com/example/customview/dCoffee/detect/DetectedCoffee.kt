...
import com.example.customview.dCoffee.databinding.ActivityDetectedCoffeeBinding
...
class DetectedCoffee : AppCompatActivity() {
    private lateinit var binding: ActivityDetectedCoffeeBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDetectedCoffeeBinding.inflate(layoutInflater)
